...
{
    if (argc != 4) {
        cout << "usage: rasprec sampling_rate duration filename\n";
        return 0;
    }
    
    Recorder* recorder(RASPRecorder::GetInstance());
    ...
    recorder->Initialize("/dev/rasp/adc0", 8, sampling_rate, 1024 * 1024);
